...
fun MainScreenView(
    ...
    LaunchedEffect(currentRoute) {
        NotificationNavigationController.destinations.collectLatest { pendingDestination ->
            ...
            val route = when (destination) {
                ...
                NotificationDestination.RealityCheck -> Route.NotificationSettings
    ...
    val backgroundImageModifier = Modifier
        .fillMaxSize()
        .graphicsLayer {
    ...
    val mainContentAlpha by animateFloatAsState(
        ...
        animationSpec = tween(
            durationMillis = 720,
            delayMillis = if (shouldShowMainContent) 90 else 0,
                    ...
                    Box(modifier = Modifier.fillMaxSize()) {
                        ...
                        AnimatedVisibility(
                            ...
                            MembershipGiftBubble(
                                ...
                                onClick = {
                                    onMainEvent(MainScreenEvent.TriggerVibration)
                                    onNavigateToPremiumFlow(PremiumEntrySource.JournalGiftBubble)
                                }
                            )
                        }
                    }
...
private fun DailyDreamTokensDrawerSection(
    ...
    val hasClaimed = remainingTokens == 0 && tokensClaimedToday > 0
    val claimEnabled = remainingTokens > 0 && !isClaiming
    Row(
        modifier = Modifier
        ...
        Row(
            ...
            Text(
                text = if (hasClaimed) "Done" else "Claim",
                color = Color.White,
                fontSize = 12.sp,
                fontWeight = FontWeight.Bold,
                maxLines = 1
...
fun DailyTokensScreen(
    ...
    val hasClaimed = remainingTokens == 0 && claimedToday > 0
