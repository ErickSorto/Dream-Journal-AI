...
sealed class MainScreenEvent {
    ...
    data class SetBackgroundIntroComplete(val state: Boolean) : MainScreenEvent()
    data class SetBackgroundBlurComplete(val state: Boolean) : MainScreenEvent()
    data class SetAuthTransitionInProgress(val state: Boolean) : MainScreenEvent()
    data class SetMainContentHandoffInProgress(val state: Boolean) : MainScreenEvent()
    ...
    data class ClaimDailyDreamTokens(val isPremium: Boolean) : MainScreenEvent()
