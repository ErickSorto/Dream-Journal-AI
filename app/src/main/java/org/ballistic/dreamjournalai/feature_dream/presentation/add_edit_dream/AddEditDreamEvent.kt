...
sealed class AddEditDreamEvent{
    ...
    data class ChangeColorText(val colorText: Int) : AddEditDreamEvent()
    data class ChangeLucidity(val lucidity: Int) : AddEditDreamEvent()
    data class ChangeDate(val date: String) : AddEditDreamEvent()
    data class ChangeTime(val time: String) : AddEditDreamEvent()
    data class ChangeVividness(val vividness: Int) : AddEditDreamEvent()
    data class ChangeDreamType(val dreamType: Int) : AddEditDreamEvent()
